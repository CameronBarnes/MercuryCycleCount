...
public class DebugUtils {
	...
	public static ArrayList<Bin> generateTestBinData(int numBins) {
		...
		bins.add(new Bin(generateRandomBinNumber(), RandomStringUtils.random(10, true, true), new ArrayList<>()));
		...
		for (int i = 1; i < numBins; i++) {
			...
			bins.add(new Bin(binNum, warehouse, DebugUtils.generateTestPartList(binNum, warehouse, shouldHaveComments, numParts)));
